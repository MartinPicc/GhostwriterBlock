...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/update.js");
...
async function execute_prompt(prompt) {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_7__["default"].post('https://europe-west1.gcp.data.mongodb-api.com/app/wordpress-backend-wirqj/endpoint/completion', {
      prompt: prompt,
...
function Edit(_ref) {
  ...
  const closeModal = function () {
    let insert = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    setOpen(false);
    if (insert) {
      setAttributes({
        content: result
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.BlockControls, {
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ToolbarDropdownMenu, {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Generate text', 'ghostwriterblock')
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Write a paragraph about:', 'ghostwriterblock"'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Write in plain words, in a descriptive manner, the desired topic for this paragraph', 'ghostwriterblock"'),
    value: prompt,
    ...
    onClick: async event => {
      ...
      event.target.innerText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Generating...', 'ghostwriterblock"');
      setAttributes({
        result: await execute_prompt(prompt)
      });
      event.target.disabled = false;
      event.target.innerText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Generate text', 'ghostwriterblock"');
    }
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Generate text', 'ghostwriterblock"')))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.RichText, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    tagName: "p",
    identifier: "content",
    value: content,
    ...
    onRemove: onRemove,
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Text paragraph', 'ghostwriterblock'),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Write text or enter a prompt in the settings', 'ghostwriterblock'),
    onMerge: mergeBlocks
  }, blockProps)), isOpen && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Modal, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Generated text', 'ghostwriterblock'),
    onRequestClose: closeModal
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", null, result), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Button, {
    variant: "primary",
    onClick: () => closeModal(true)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Insert', 'ghostwriterblock'))));
}
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save({
    className
...
const transforms = {
  from: [{
    ...
    transform: attributes => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ghostwriterblock/paragraph', {
      ...attributes
    })
  }],
  to: [{
    type: 'block',
    blocks: ['core/paragraph'],
    transform: attributes => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('core/paragraph', {
      ...attributes
    })
  }]
};
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"ghostwriterblock/paragraph","version":"0.1.0","title":"Ghostwriter Paragraph","category":"text","icon":"testimonial","description":"AI assisted paragraph to help you write faster","keywords":["text","ghostwriter","AI"],"textdomain":"ghostwriterblock","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"align":{"type":"string"},"prompt":{"type":"string"},"result":{"type":"string"},"content":{"type":"string","source":"html","selector":"p","default":"","__experimentalRole":"content"}},"supports":{"anchor":true,"color":{"gradients":true,"link":true,"__experimentalDefaultControls":{"background":true,"text":true}},"spacing":{"margin":true,"padding":true},"typography":{"fontSize":true,"lineHeight":true,"__experimentalFontFamily":true,"__experimentalTextDecoration":true,"__experimentalFontStyle":true,"__experimentalFontWeight":true,"__experimentalLetterSpacing":true,"__experimentalTextTransform":true,"__experimentalDefaultControls":{"fontSize":true}},"__experimentalSelector":"p","__unstablePasteTextInline":true}}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkghostwriterblock"] = globalThis["webpackChunkghostwriterblock"] || [];
